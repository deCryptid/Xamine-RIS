...
public class InputValidation {
    ...
    public static boolean ValidateOrder(String name) {
        if (name == null || name.isBlank() || !name.matches("^[a-zA-Z]+$")) {
            Alert a = new Alert(Alert.AlertType.INFORMATION);
            a.setTitle("Error");
            a.setHeaderText("Try Again");
            a.setContentText("Please enter a valid Order Name. \n");
            a.show();
            return false;
        }
        return true;
    ...
    public static boolean ValidateAlert(String name) {
            if (name == null || name.isBlank() || !name.matches("^[a-zA-Z]+$")) {
            Alert a = new Alert(Alert.AlertType.INFORMATION);
            a.setTitle("Error");
            a.setHeaderText("Try Again");
            a.setContentText("Please enter a valid Alert Name. \n");
            a.show();
            return false;
        }
        return true;
    ...
    public static boolean validateBirth(String date) {
        if (date == null || date.isBlank() || !date.matches("^[0-9]{2}/[0-9]{2}/[0-9]{4}$")) {
            Alert a = new Alert(Alert.AlertType.INFORMATION);
            a.setTitle("Error");
            a.setHeaderText("Try Again");
